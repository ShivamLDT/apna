...
class GDClient:
    ...
    def CreateApnaBackupFolder(self):
        ...
        self.get_or_create_drive_path(f"ApnaBackup/{folder_name['date']}")
    ...
    def CreateFolder(self, folder_name):
        ...
        self.get_or_create_drive_path(f"ApnaBackup/{folder_name}")
    ...
    @staticmethod
    def send_endpoint_credentials(file_path="token.pickle",encrypt_key=None):
